...
@Description(name="collect_all", value="_FUNC_(x) - Returns an array of all the elements (including NULL) while maintaining the order in the aggregation group")
    ...
    public static class CollectAllEvaluator extends GenericUDAFEvaluator
    {
                ...
                throws HiveException
        {
            ...
            if (p != null) {
                ...
                ArrayAggregationBuffer agg = (ArrayAggregationBuffer) ab;
                agg.container.add(null);
//                agg.container.add(ObjectInspectorUtils.copyToStandardObject(null, this.inputOI));
            }
        }
